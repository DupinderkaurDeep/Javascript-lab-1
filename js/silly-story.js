...
function result() {
    ...
    var userName = customName.value.trim();
    if (userName !== "") {
        newStory = newStory.replace(/Bob/g, userName);
    }
    ...
    if (document.getElementById("metric").checked) {
        var weight = 300 * 0.453592; // pounds to kilograms conversion
        newStory = newStory.replace("300 pounds", weight.toFixed(2) + " kilograms");

        var temp = ((94 - 32) * 5) / 9; // Fahrenheit to Celsius conversion
